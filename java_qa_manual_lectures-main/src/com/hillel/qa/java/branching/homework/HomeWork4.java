...
public class HomeWork4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Введіть першу довжину трикутника");
        double a = scanner.nextInt();
        System.out.println("Введіть другу довжину трикутника");
        double b = scanner.nextInt();
        System.out.println("Введіть третью довжину трикутника");
